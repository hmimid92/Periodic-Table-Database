...
--
-- Name: properties_atomic_number_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.properties_atomic_number_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.properties_atomic_number_seq OWNER TO freecodecamp;

--
-- Name: properties_atomic_number_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.properties_atomic_number_seq OWNED BY public.properties.atomic_number;


--
-- Name: properties_type_id_seq; Type: SEQUENCE; Schema: public; Owner: freecodecamp
--

CREATE SEQUENCE public.properties_type_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE public.properties_type_id_seq OWNER TO freecodecamp;

--
-- Name: properties_type_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: freecodecamp
--

ALTER SEQUENCE public.properties_type_id_seq OWNED BY public.properties.type_id;
...
INSERT INTO public.properties VALUES (20.18, -248.6, -246.1, 1, 10);
INSERT INTO public.properties VALUES (18.998, -220, -188.1, 1, 9);
INSERT INTO public.properties VALUES (1.008, -259.1, -252.9, 1, 1);
INSERT INTO public.properties VALUES (4.0026, -272.2, -269, 1, 2);
INSERT INTO public.properties VALUES (12.011, 3550, 4027, 1, 6);
INSERT INTO public.properties VALUES (14.007, -210.1, -195.8, 1, 7);
INSERT INTO public.properties VALUES (15.999, -218, -183, 1, 8);
INSERT INTO public.properties VALUES (6.94, 180.54, 1342, 2, 3);
INSERT INTO public.properties VALUES (9.0122, 1287, 2470, 2, 4);
INSERT INTO public.properties VALUES (10.81, 2075, 4000, 3, 5);
...
--
-- Name: properties_atomic_number_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.properties_atomic_number_seq', 10, true);


--
-- Name: properties_type_id_seq; Type: SEQUENCE SET; Schema: public; Owner: freecodecamp
--

SELECT pg_catalog.setval('public.properties_type_id_seq', 9, true);
